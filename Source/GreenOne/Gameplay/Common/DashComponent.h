 ...
 */
UCLASS()
class GREENONE_API UDashComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
public:
	...
	void SetCharacter(AGreenOneCharacter* character) { Character = character; };
